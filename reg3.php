...
{
 header("location:reg3.php?fail=1");   
}
 else {
   ...
   $count=rand('100000','999999');
    ...
    move_uploaded_file($_FILES['myFile']['tmp_name'],getcwd()."//img5//$nfn");
    
   
     move_uploaded_file($_FILES['myFile']['tmp_name'],getcwd()."//img3//$nfn");
    
           
               
               
               
    $ins1=mysqli_query($dbcon,"insert into com_data values('','$t1','','','','$t5','$t6','$t7','$t8','$nfn','0','3')");
    ...
    if($ins1>0)
    {
         ...
         $ins2=mysqli_query($dbcon,"insert into staff_data values('','$t1','','','','$t5','$t6','$t7','$nfn','','1')");
    
    if($ins2>0)
    {
        
        
      $ins3=mysqli_query($dbcon,"insert into user_log values('','$t6','$t7','usr1','1')");
        if($ins3>0)
        {
                header("location:reg3.php?suss=1");
            }
    }}
        }
 }
