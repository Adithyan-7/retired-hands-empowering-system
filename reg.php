...
if(mysqli_num_rows($log1)>0)
{
 header("location:reg.php?fail=1");   
    ...
    {
    $ins=mysqli_query($dbcon,"insert into user_data values('','$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8','$t9','$t10','$t11','$t12','$t13','$nfn','$nfn1','0','$ta','0')");
			...
			<form  method="post" enctype="multipart/form-data">
				...
				<div class="w3_form_body_grid w3_form_body_grid1">
					...
					<span>Fee</span>
                              ...
                              <div class="w3_form_body_grid w3_form_body_grid1">
					<span>Contact</span>
                                        <input type="text" name="t10" placeholder="Contact Info" required="" onkeyup="chkc(this.value)" >
				</div>
                               <span id="o3"></span>
				<div class="w3_form_body_grid">
					<span>Email</span>
                                        <input type="email" name="t11" placeholder="Email" required=""onkeyup="vem(this.value)" >
				</div>
                               <span id="em"></span>
				<div class="w3_form_body_grid w3_form_body_grid1">
					<span>Password</span>
					<input type="password" name="t12" placeholder="Password" required="">
                               ...
                               <div class="w3_form_body_grid">
					<span>UPI ID</span>
					<input type="text" name="t13" placeholder="Your UPI ID" required="">
				</div>
                               <div class="w3_form_body_grid w3_form_body_grid1">
					...
					<input name="myFile" class="frm-field required" class="form-control" type="file"required="">
                               ...
                               <div class="w3_form_body_grid w3_form_body_grid1">
					<span>Id Proof & other Documents</span>
